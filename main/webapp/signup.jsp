            ...
            <div class="card-body">
                <form action="/register" method="post">
                    ...
                    <div class="input-group form-group">
                        ...
                        <input name="txtPasswordAgain" type="password" class="form-control" placeholder="password again">
                    </div>
                    <div class="form-group">
                        <input type="submit" value="Sign up" class="float-right btn login_btn">
                    </div>
                </form>
            </div>
